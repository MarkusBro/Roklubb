...
public class ClassResultatsModel {
    ...
    public ClassResultatsModel(String rank, String score,String firstName, String lastName, String clubName, String className, Date startDate, Double Watt5, Time Time5, Double Watt2, Time Time2, Double Watt60, Double lierowProsent, Double lierowKg, Double squatProsent, Double squatKg, int Flexibility) {
        this.rank=rank;
        this.score=score;
        fname = firstName;
        lname = lastName;
