...
VALUES ('OlaNordmann@krsRoklubb.no', 'someLongPassword', 'Ola', 'Nordmann', '1991-02-15',
        'I started rowing back in 2015, and I have been a diligent member since.'),
       ('KariNordkvinne@ArendalRoklubb.no', 'someShortPassword', 'Kari', 'Nordkvinne', '1993-05-17',
        'I started rowing in 2014, and have been an avid member of the club since then.'),
       ('JohnSmith@RRPadleklubb.no', 'someMediumPassword', 'John', 'Smith', '1973-01-03',
        'I am no longer in brilliant shape, but I love rowing regardless.');
